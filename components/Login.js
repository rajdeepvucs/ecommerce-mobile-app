    ...
    <View className="bg-white h-full w-full">
     ...
     <View className="flex items-center mx-4 space-y-4">
        ...
        <Animated.View entering={FadeInDown.delay(200).duration(1000).springify()} className="w-full">
            <TouchableOpacity className="w-full bg-sky-400 p-3 rounded-2xl mb-3" onPress={()=>{navigation.navigate('OTP')}}>
        ...
        <Animated.View entering={FadeInDown.duration(1000).springify()}className="flex-row justify-center">
            <Text className="text-white text-xl font-normal">Do not have account?</Text>
            <TouchableOpacity onPress={()=>{navigation.navigate('SignUp')}}>
                <Text className="text-sky-600   text-2xl font-normal">SignUp</Text>
            </TouchableOpacity>
        </Animated.View>
     </View>
    </View>
