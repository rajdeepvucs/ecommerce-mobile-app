...
const[loading,setLoading]=useState(false);
  const getData = async () => {
   ...
   setData(res.data.filter(item =>item.category==='HOME MADE MASALA'))
      setFilteredData(res.data.filter(item =>item.category==='HOME MADE MASALA')); // Initialize filteredData with full data set
    } catch (error) {
      console.log(error);
    }
    finally{
